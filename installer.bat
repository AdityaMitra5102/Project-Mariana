...
curl -L -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64)" "https://download-installer.cdn.mozilla.net/pub/firefox/releases/138.0.4/win64/en-US/Firefox Setup 138.0.4.msi" -o firefox.msi
